...
namespace Novacta.Documentation.ShfbTools
{
    ...
    static class Shfb
    {
        ...
        /// <summary>
        /// Gets the version of the target SHFB.
        /// </summary>
        /// <value>The version of the target SHFB.</value>
        ...
        /// </summary>
        /// <typeparam name="T">The type of the update information.</typeparam>
        /// <param name="updater">A function that takes a path and
        /// enumerates the file
        /// managers encapsulating the updating logic for such specific path.</param>
        /// <param name="updateInfo">The update information.</param>
        /// <param name="path">The path of the SHFB installation to update.</param>
        /// <returns>A value equal to <c>0</c> for successful updates; nonzero otherwise.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="updater" /> is <b>null</b>.<br />
        /// -or-<br /><paramref name="path" /> is <b>null</b>.</exception>
        /// <exception cref="InvalidOperationException">The specified path does not appear as the root of a SHFB installation.<br />
        /// -or-<br />
        /// The specified path is the root of a SHFB installation
        /// but its version differs from the target one.</exception>
            ...
            try
            {
                          ...
                          "SHFBProjectLauncher.exe")))
                {
                    throw new InvalidOperationException(
                        "The specified path does not appear to be the root of a SHFB installation.");
                }
                else
                {
                    ...
                    // The file version is missing the century to satisfy 
                    // the MSI rule for the major version value,
                    // so we'll add the century back from the SHFB version 
                    // to get a match.
                    var version = new Version(
                        fvi.FileMajorPart + 2000,
                        fvi.FileMinorPart,
                        fvi.FileBuildPart,
                        fvi.FilePrivatePart);
                    if (version != Shfb.TargetVersion)
                    {
                        throw new InvalidOperationException(
                        "The specified path is the root of a SHFB installation " +
        ...
        static Shfb()
        {
            Shfb.TargetVersion = new Version(AssemblyInfo.Version);

            Shfb.SHFBROOT = Environment.GetEnvironmentVariable(
                "SHFBROOT",
                EnvironmentVariableTarget.Machine);
        }

        static string[] presentationStyles = new string[4] {
            "Markdown",
            "OpenXml",
            "VS2010",
            "VS2013" };
        ...
        /// <returns>The Sandcastle main style sheet corresponding 
            ...
            string presentationStyle)
        {
            ...
            string mainStyleSheet = null;
            switch (presentationStyle)
            {
                case "Markdown":
                case "OpenXml":
                    mainStyleSheet = "MainSandcastle.xsl";
                    break;
                case "VS2010":
                case "VS2013":
                    mainStyleSheet = "main_sandcastle.xsl";
                    break;
                default:
                    throw new ArgumentException(
        ...
        /// </summary>
        /// <param name="presentationStyle">The presentation style.</param>
        /// <returns>The Conceptual main style sheet corresponding 
        /// to the specified presentation style.</returns>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="presentationStyle"/> is <b>null</b>.
        /// </exception>
            ...
            string presentationStyle)
        {
            ...
            switch (presentationStyle)
            {
                case "Markdown":
                case "OpenXml":
                    mainStyleSheet = "MainConceptual.xsl";
                    break;
                case "VS2010":
                case "VS2013":
                    mainStyleSheet = "main_conceptual.xsl";
                    break;
            }
        ...
        /// <param name="presentationStyle">The presentation style.</param>
        /// <param name="topics">The topics for which the sheets 
        /// are to be imported.</param>
        /// <param name="styleSheets">
        /// The style sheets to import.</param>
        /// <returns>
        /// <remarks>
        /// <para>
        ...
        /// operation.</returns>
        /// <exception cref="ArgumentNullException">Parameter <paramref name="shfbPath" /> is <b>null</b>.<br />
        /// -or-<br />
        /// Parameter <paramref name="presentationStyle" /> is <b>null</b>.<br />
        /// -or-<br />
        /// Parameter <paramref name="styleSheets" /> is <b>null</b>.</exception>
        /// <exception cref="ArgumentException">Parameter <paramref name="shfbPath" /> is empty.<br />
        /// -or-<br />
        ...
        /// least an element which is <b>null</b> or empty.</exception>
        ...
        /// </summary>
        /// <param name="presentationStyle">The presentation style.</param>
        /// <returns>The collection of shared content files corresponding 
        /// to the specified presentation style.</returns>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="presentationStyle"/> is <b>null</b>.
        /// </exception>
            ...
            string presentationStyle)
        {
            ...
            List<string> sharedContentFiles = new List<string>();
            switch (presentationStyle)
            {
                case "Markdown":
                case "OpenXml":
