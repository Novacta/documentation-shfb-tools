...
{
    /// <summary> 
    /// Represents a process which supports elaboration on files.
    /// </summary>
    public abstract class FileProcessor
    {
        ...
        /// <param name="additionalInfo">Additional information needed to
        /// evaluate arguments specific to the processed file.</param>
        /// <returns>The output of the file processor.</returns>
        /// <exception cref="System.InvalidOperationException">
        /// The process exited with errors.</exception>
        ...
        /// <param name="additionalInfo">Additional information needed to
        /// evaluate arguments specific to the processed file.</param>
        /// <returns>A string representation of the process arguments.</returns>
        public abstract string Arguments(string fileName, string additionalInfo);

        /// <summary>
        /// Gets the path of the processor.
        /// </summary>
        /// <value>The path of the processor.</value>
