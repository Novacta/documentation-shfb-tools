...
namespace Novacta.Documentation.ShfbTools
{
    ...
    /// </summary>
    /// <remarks>
    /// <see cref="DviPng"/> instances convert DVI files 
    /// into PNG files.
    /// </remarks>
    public class DviPng : FileProcessor
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DviPng"/> class.
        /// </summary> 
        /// <param name="latexBinPath">The LaTeX bin path.</param>
        /// <param name="workingPath">The working path.</param>
        /// <param name="defaultImageResolution">The default image resolution.</param>
        public DviPng(string latexBinPath, string workingPath, string defaultImageResolution)
        {
            /*
             *  ‘--depth*’  
